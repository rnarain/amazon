...
class Order extends Component {
  ...
  handleTabChange = (e) => {
    ...
    var queryType;
    if (e.target.name == "deliveredOrdersTab") {
      this.setState({
        deliveredOrdersClassname: "selected",
        cancelledOrdersClassname: "",
        openOrdersClassname: ""
      })
      queryType = "Delivered";
                ...
                <div id="controlsContainer">
                  <div id="orderTypeMenuContainer" className="a-row a-spacing-medium custom-view-options">
                    <ul className="a-unordered-list a-nostyle a-horizontal" role="tablist">
                      ...
                      <li className={this.state.deliveredOrdersClassname} name="deliveredOrdersTab" onClick={this.handleTabChange} >
                      <Button variant="link" name="deliveredOrdersTab"  className="a-list-item" onClick={this.handleTabChange}>
                          Delivered Orders
                      </Button>
                      </li>
