    ...
    axios.post(backendServer + 'orders/getOrders', data)
      .then(response => {
        if (response) {
          ...
          let status = ["Delivered" , "Cancelled"]
          this.setState({
            orderList: response.data,
            filteredOrderedList : response.data.filter(f=>!status.includes(f.deliverystatus))
          })
        } else {
          // No orders found
                ...
                <div className="a-fixed-right-grid-col a-col-left" style={{ paddingRight: '0%', float: 'left' }}>
                  <div className="a-row">
                    ...
                    <div className="a-column a-span2">
                      ...
                      <div className="a-row a-size-base">
                        <span className="a-color-secondary value">
                          ${eachOrder.quantity * eachOrder.productprice}
                        </span>
                      </div>
                    </div>
            ...
            <div id="yourOrders" role="main">
              <div id="yourOrdersContent">
                ...
                <div id="controlsContainer">
                  <div id="orderTypeMenuContainer" className="a-row a-spacing-medium custom-view-options">
                    <ul className="a-unordered-list a-nostyle a-horizontal" role="tablist">
                      ...
                      <li className={this.state.ordersClassname} name="ordersTab"  role="tab"><span className="a-list-item">
                      <Button variant="link" name="ordersTab" onClick={()=>{this.handleTabChange("Open")}}>
                          Open Orders
                 </Button>
                      </span></li>

                      <li role="tab" className={this.state.openOrdersClassname} name="openOrdersTab"  >
                      <Button variant="link" name="openOrdersTab" className="a-list-item" onClick={()=>{this.handleTabChange("Delivered")}}>
                          Delivered Orders
                          </Button>
                          </li>

                      <li role="tab" className={this.state.cancelledOrdersClassname} name="cancelledOrdersTab"  >
                      <Button variant="link" name="cancelledOrdersTab" className="a-list-item" onClick={()=>{this.handleTabChange("Cancelled")}}>
                          Cancelled Orders
                          </Button></li>
                    </ul>
                  </div>
                ...
                <div id="ordersContainer">
                  ...
                  <JwPagination pageSize="5" items={this.state.filteredOrderedList} onChangePage={this.onChangePage} />
                  </div>
